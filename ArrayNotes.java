...
public class ArrayNotes
{
    ...
    public static void createArrayOfCalendars()
    {
         ...
         *      of each month.
         *      
         *  When we create an array of references objects, each element is initialized
         *      to null. We have to explicitly create *new* objects and assign the
         *      corresponding reference to each element.
         */
        ...
        /*
         * Create new calendar objects and assign their refernces to each element
         *      in the array.
         */
         ...
         *      which modify the properties of the referenced objects (e.g., day of month).
         */
        for(GregorianCalendar calendar : calendars)
        {
